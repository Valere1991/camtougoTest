...
@Service
public class EmailRegistrationAdminService {
    ...
    public String registerAdmin(RegistrationRequest request) {
        ...
        String token = userService.savedAdmin(
                new User(
        ...
        String link = "http://localhost:8082/admin/register/confirm?token=" + token;
